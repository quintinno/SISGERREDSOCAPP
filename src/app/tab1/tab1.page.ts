...
import { GeradorTwitterService } from './../service/gerador-twitter.service';
...
export class Tab1Page implements OnInit {
  ...
  // public twitterList = new Array<any>();
  ...
  ngOnInit() {
    this.recuperarPostagemTwitter();
  }

  public recuperarPostagemTwitter() {
